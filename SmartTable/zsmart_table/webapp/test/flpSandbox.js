		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Table Northwind",
									"targetURL": "#comnamndzsmarttable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnamndzsmarttable-display": {
								"semanticObject": "comnamndzsmarttable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.namnd.zsmarttable",
									"url": sap.ui.require.toUrl("com/namnd/zsmarttable")
								}
							}
						}
					}
